...
# Tropical Adventure
- Created a sidescroller physics based player controller.
- Implemented jump and double jump mechanics.
- Created a vertical procedural level generation system.
- Implemented one way platforms collision to solve vertical movement obstruction problems.
- Implemented animations states.
- Implemented interactable/moveable objects.
...
- Created stats management system.
- Implemented quest system.
- Created Character selection system.
- Implemented Interactable environment.
- Created click to move movement system.
